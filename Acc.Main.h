...
#include "libstd.h"
#include "CList.h" /*to use for type statistics*/
...
#define XML_ROOT_NAME "AccountantDatabase"
#define XML_APP_VER "AppVer"
#define XML_REC_NAME "record"
#define XML_ID_NAME "ID"
#define XML_DATE_NAME "date"
#define XML_VALUE_NAME "value"
#define XML_TYPE_NAME "type"
#define XML_DESCR_NAME "descr"
...
/* === Issue 2008-02:1 === means that the issue is from Feb 2008 and is the first one*/
